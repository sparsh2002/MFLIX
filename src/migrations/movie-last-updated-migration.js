...
;(async () => {
  try {
    const host = "mongodb+srv://m220student:m220password@mflix.6ervu.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"
    ...
    const predicate = { lastupdated: { $exists: true, $type: "double" } }
